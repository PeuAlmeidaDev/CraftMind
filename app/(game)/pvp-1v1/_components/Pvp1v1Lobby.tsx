...
export default function Pvp1v1Lobby() {
    ...
    async (page: number) => {
      ...
      try {
        const res = await fetch(
          `/api/battle/pvp/history?page=${page}`,
    ...
    <div className="mx-auto max-w-2xl px-4 py-8 space-y-8">
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-sm text-gray-400 max-w-md mx-auto">
          Entre na fila e enfrente outro jogador em um duelo competitivo por
      ...
      >
        {inQueue ? (
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-300">Procurando oponente...</p>
          ...
          <div className="space-y-4">
            <p className="text-sm text-gray-400">
              Entre na fila para ser emparelhado com outro jogador.
            </p>
            <button
              type="button"
              onClick={joinQueue}
      ...
      <div>
        ...
        {loadingHistory ? (
          ...
          <p className="text-sm text-gray-500 text-center py-8">
            Nenhuma batalha PvP 1v1 encontrada.
          </p>
        ) : (
