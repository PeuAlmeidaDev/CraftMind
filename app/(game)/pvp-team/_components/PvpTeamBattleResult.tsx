...
const RANKING_POINTS: Record<PvpTeamBattleResultProps["result"], { text: string; value: string }> = {
  VICTORY: { text: "Recompensa", value: "+25 Ranking Points" },
  DEFEAT: { text: "Penalidade", value: "-15 Ranking Points" },
  DRAW: { text: "Empate", value: "+5 Ranking Points" },
};

// ---------------------------------------------------------------------------
// Component (identical design to CoopPveResult)
// ---------------------------------------------------------------------------

export default function PvpTeamBattleResult({
  result,
}: PvpTeamBattleResultProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Ranking points (replaces EXP from CoopPveResult) */}
        ...
        {/* Draw subtitle (like defeat subtitle in CoopPveResult) */}
        {isDraw && (
          <p
          ...
          >
            Forca equiparada. Nenhum time prevaleceu.
          </p>
        )}
