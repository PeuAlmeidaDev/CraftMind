...
| `UserCard` | Copia de cristal pertencente a um usuario: userId, cardId, equipped, slotIndex (0/1/2 quando equipped). Constraints unique em `[userId, cardId]` (so primeira copia) e `[userId, slotIndex]`. Indice em userId |
